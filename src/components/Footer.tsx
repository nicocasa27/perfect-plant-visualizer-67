          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <a href="mailto:info@sarovi.com" className="text-white/80 hover:text-gold transition-colors duration-200">
                  info@sarovi.com
                </a>
              </li>
              <li className="flex items-center">
                <Phone size={16} className="mr-2" />
                <a href="tel:+1234567890" className="text-white/80 hover:text-gold transition-colors duration-200">
                  +1 (234) 567-890
                </a>
              </li>
            </ul>
