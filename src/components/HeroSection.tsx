    ...
    <section className="relative py-16 md:py-20 overflow-hidden min-h-[70vh] flex items-center justify-center">
      <div className="container mx-auto">
        <div className="relative flex flex-col items-center">
          <h1 className="title-large text-center font-medium max-w-7xl">
            <span className="block animate-fade-up" style={{ animationDelay: '0.1s' }}>Practice for</span>
            <span className="block animate-fade-up" style={{ animationDelay: '0.3s' }}>Atlasology</span>
            <div className="inline-block mx-4 animate-fade-up" style={{ animationDelay: '0.5s' }}>
              <CirclePlant />
            </div>
            <span className="block animate-fade-up" style={{ animationDelay: '0.7s' }}>and</span>
            <span className="block animate-fade-up" style={{ animationDelay: '0.9s' }}>Naturopathy</span>
          </h1>
        </div>
      </div>
    </section>
